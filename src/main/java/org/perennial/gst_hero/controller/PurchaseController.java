...
public class PurchaseController {
    ...
    public ResponseEntity<ApiResponseDTO<Object>> savePurchaseDetails(@Valid @RequestBody PurchaseDTO purchaseDTO) {
        ...
        if (!isUserExist) {
            ApiResponseDTO<Object> apiResponseDTO=purchaseRequestHandler.apiResponse(Collections.emptyList(), ErrorMessage.USER_NOT_FOUND, HttpStatus.NOT_FOUND.value(),ErrorMessage.ERROR_STATUS);
            return new ResponseEntity<>(apiResponseDTO,HttpStatus.NOT_FOUND);
        }
        purchaseRequestHandler.savePurchaseDetails(purchaseDTO);
        ApiResponseDTO<Object> apiResponseDTO=purchaseRequestHandler.apiResponse(Collections.emptyList(), SuccessMessage.PURCHASE_CREATED, HttpStatus.CREATED.value(), SuccessMessage.SUCCESS_STATUS);
     ...
     */
    @PostMapping("/history")
    public ResponseEntity<ApiResponseDTO<Object>> generatePurchaseHistory(@RequestBody PurchaseParameterDTO purchaseParameterDTO) {
        log.info("START :: CLASS :: PurchaseController :: METHOD :: generatePurchaseHistory :: purchaseParameterDTO:{}:: ",purchaseParameterDTO);
        ...
        if (isReportGenerated) {
            ApiResponseDTO<Object> apiResponseDTO=purchaseRequestHandler.apiResponse(Collections.emptyList(),ErrorMessage.PURCHASE_REPORT_ALREADY_GENERATED,HttpStatus.CONFLICT.value(),ErrorMessage.ERROR_STATUS);
        ...
        ApiResponseDTO<Object> apiResponseDTO=purchaseRequestHandler.apiResponse(Collections.emptyList(),SuccessMessage.PURCHASE_HISTORY_GENERATION_REQUEST,HttpStatus.CREATED.value(), SuccessMessage.SUCCESS_STATUS);
        log.info("END :: CLASS :: PurchaseController :: METHOD :: generatePurchaseHistory :: purchaseParameterDTO:{}:: ",purchaseParameterDTO);
        return new ResponseEntity<>(apiResponseDTO,HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<ApiResponseDTO<Object>> deletePurchaseDetails(@PathVariable long userId,
        ...
        ApiResponseDTO<Object> apiResponseDTO=purchaseRequestHandler.apiResponse(Collections.emptyList(),SuccessMessage.PURCHASE_DETAILS_DELETED,HttpStatus.OK.value(), SuccessMessage.SUCCESS_STATUS);
